        ...
        |> Array.scan(fun ((si: ScheduleItem), (a: Accumulator)) ap ->
            ...
            let accumulator =
                { a with
                    ...
                    CumulativeActualPayments = a.CumulativeActualPayments + Array.sum ap.ActualPayments
            ...
            let generatedPayment, netEffect =
                ...
                | IntendedPurpose.Quote AllOverdue when ap.GeneratedPayment.IsSome ->
                    ValueSome (accumulator.CumulativeMissedPayments + interestPortion + chargesPortion - Array.sum ap.ActualPayments)
                    |> fun p -> p, (p |> ValueOption.defaultValue netEffect)
                | _ ->
            ...
            let scheduleItem, generatedPayment =
                ...
                | ValueSome _, IntendedPurpose.Quote AllOverdue ->
                    ...
                    let paymentStatus =
                        ...
                        | RefundDue ->
                            Refunded
                        | _ ->
                            if paymentDue = 0L<Cent> && Array.sum ap.ActualPayments = 0L<Cent> && (generatedPayment.IsNone || generatedPayment.Value = 0L<Cent>) then
                                NothingDue
                            else
                                ap.PaymentStatus
                ...
                | ValueSome _, IntendedPurpose.Quote Settlement ->
                    ...
                    let generatedPayment = si.PrincipalBalance + si.FeesBalance - feesRefund + interestPortion + chargesPortion - Array.sum ap.ActualPayments
