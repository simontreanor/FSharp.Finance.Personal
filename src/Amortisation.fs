...
module Amortisation =
    ...
    type ScheduleItem = {
        ...
        PaidBy: Map<(uint<OffsetDay> * int), int64<Cent>>
    ...
    type FinalStats = {
        ...
        SettlementFigure: (uint<OffsetDay> * int64<Cent>) voption
            ...
            let feePortion', feeRebate =
                ...
                then
                    let feeRebate' =
                        ...
                        | Apr.CalculationMethod.UnitedKingdom when feeRebateIfSettled > 0L<Cent> ->
