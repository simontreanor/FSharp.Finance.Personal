...
module Amortisation =
    ...
    let calculate sp intendedPurpose (appliedPayments: AppliedPayment array) =
        ...
        |> Array.scan(fun ((si: ScheduleItem), (a: Accumulator)) ap ->
            ...
            let confirmedPayments = ap.ActualPayments |> Array.sumBy(function PaymentStatus.Confirmed ap -> ap | _ -> 0L<Cent>)

            let pendingPayments = ap.ActualPayments |> Array.sumBy(function PaymentStatus.Pending ap -> ap | _ -> 0L<Cent>)
