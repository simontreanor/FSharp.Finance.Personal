...
module Rescheduling =
    ...
    type RescheduleParameters = {
        ...
        FeeettlementRefund: Fee.SettlementRefund
    ...
    let reschedule sp (rp: RescheduleParameters) actualPayments =
        ...
        let spNew =
            { sp with
                ...
                FeeConfig = sp.FeeConfig |> Option.map(fun fc -> { fc with SettlementRefund = rp.FeeettlementRefund })
                InterestConfig =
    ...
    let rollOver sp (rp: RolloverParameters) actualPayments =
        ...
        let principalPortion, feePortion, feeRefundIfSettled =
            match quote.QuoteResult with
            | PaymentQuote ({ Apportionment = a } as pq) ->
                match rp.FeeHandling with
                | Fee.FeeHandling.CapitaliseAsPrincipal -> a.PrincipalPortion + a.FeePortion + a.InterestPortion + a.ChargesPortion, 0L<Cent>, pq.FeeRefundIfSettled
                | Fee.FeeHandling.CarryOverAsIs -> a.PrincipalPortion + a.InterestPortion + a.ChargesPortion, a.FeePortion, pq.FeeRefundIfSettled
                | Fee.FeeHandling.WriteOffFeeBalance -> a.PrincipalPortion + a.InterestPortion + a.ChargesPortion, a.FeePortion, pq.FeeRefundIfSettled
                    ...
                    |> Option.bind(fun fc ->
                        ...
                        | Fee.FeeHandling.CarryOverAsIs ->
                            { fc with
                                ...
                                SettlementRefund =
                                    if feeRefundIfSettled = 0L<Cent> then
