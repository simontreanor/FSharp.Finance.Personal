...
<div>
    ...
    <div>Initial cost-to-borrowing ratio: <i>63.39 %</i></div>
    <div>Initial APR: <i>1274.3 %</i></div>
    <div>Level payment: <i>129.59</i></div>
    <div>Final payment: <i>129.59</i></div>
    <div>Last scheduled payment day: <i>118</i></div>
    <div>Total scheduled payments: <i>518.36</i></div>
    <div>Total principal: <i>317.26</i></div>
    <div>Total interest: <i>201.10</i></div>
</div></fieldset>