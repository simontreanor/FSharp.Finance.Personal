...
<div>
    ...
    <div>Initial cost-to-borrowing ratio: <i>68.16 %</i></div>
    <div>Initial APR: <i>1251.7 %</i></div>
    <div>Level payment: <i>133.38</i></div>
    <div>Final payment: <i>133.35</i></div>
    <div>Last scheduled payment day: <i>123</i></div>
    <div>Total scheduled payments: <i>533.49</i></div>
    <div>Total principal: <i>317.26</i></div>
    <div>Total interest: <i>216.23</i></div>
</div></fieldset>