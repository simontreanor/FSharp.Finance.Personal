...
<div>
    ...
    <div>Initial cost-to-borrowing ratio: <i>84.36 %</i></div>
    <div>Initial APR: <i>1251.8 %</i></div>
    <div>Level payment: <i>116.99</i></div>
    <div>Final payment: <i>116.94</i></div>
    <div>Last scheduled payment day: <i>154</i></div>
    <div>Total scheduled payments: <i>584.90</i></div>
    <div>Total principal: <i>317.26</i></div>
    <div>Total interest: <i>267.64</i></div>
</div></fieldset>