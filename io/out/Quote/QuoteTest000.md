...
<div>
    <div>Generated settlement: <i>1,969.72 on day 57</i></div>
    <div>Final balance status: <i>closed</i></div>
    <div>Effective interest rate: <i>0.0169868508 % per day</i></div>
    <div>Final cost-to-borrowing ratio: <i>76.64 %</i></div>
