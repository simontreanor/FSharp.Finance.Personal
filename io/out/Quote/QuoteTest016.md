...
<h4>Description</h4>
<p><i>Loan is settled the day before an overpayment (note: if looked at from a later date the overpayment will cause a rebate to be due)</i></p>
