...
<div>
    <div>Generated settlement: <i>429.24 on day 133</i></div>
    <div>Final balance status: <i>closed</i></div>
    <div>Effective interest rate: <i>0.4623084577 % per day</i></div>
    <div>Final cost-to-borrowing ratio: <i>61.95 %</i></div>
    <div>Required scheduled payment count: <i>4</i></div>
    <div>Last required scheduled payment day: <i>106</i></div>
