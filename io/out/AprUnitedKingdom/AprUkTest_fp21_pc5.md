...
<div>
    <div>Initial interest balance: <i>296.76</i></div>
    <div>Initial cost-to-borrowing ratio: <i>93.54 %</i></div>
    <div>Initial APR: <i>2544.6 %</i></div>
    <div>Level payment: <i>122.81</i></div>
    <div>Final payment: <i>122.78</i></div>
    <div>Last scheduled payment day: <i>143</i></div>
    <div>Total scheduled payments: <i>614.02</i></div>
    <div>Total principal: <i>317.26</i></div>
    <div>Total interest: <i>296.76</i></div>
</div></fieldset>