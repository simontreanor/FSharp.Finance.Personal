...
<div>
    <div>Initial interest balance: <i>371.22</i></div>
    <div>Initial cost-to-borrowing ratio: <i>117.01 %</i></div>
    <div>Initial APR: <i>2561 %</i></div>
    <div>Level payment: <i>114.75</i></div>
    <div>Final payment: <i>114.73</i></div>
    <div>Last scheduled payment day: <i>175</i></div>
    <div>Total scheduled payments: <i>688.48</i></div>
    <div>Total principal: <i>317.26</i></div>
    <div>Total interest: <i>371.22</i></div>
</div></fieldset>