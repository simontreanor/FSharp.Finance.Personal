...
<div>
    <div>Initial interest balance: <i>213.95</i></div>
    <div>Initial cost-to-borrowing ratio: <i>67.44 %</i></div>
    <div>Initial APR: <i>2732.7 %</i></div>
    <div>Level payment: <i>132.81</i></div>
    <div>Final payment: <i>132.78</i></div>
    <div>Last scheduled payment day: <i>107</i></div>
    <div>Total scheduled payments: <i>531.21</i></div>
    <div>Total principal: <i>317.26</i></div>
    <div>Total interest: <i>213.95</i></div>
</div></fieldset>