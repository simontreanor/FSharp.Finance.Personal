...
<div>
    <div>Initial interest balance: <i>248.06</i></div>
    <div>Initial cost-to-borrowing ratio: <i>78.19 %</i></div>
    <div>Initial APR: <i>2161.7 %</i></div>
    <div>Level payment: <i>141.34</i></div>
    <div>Final payment: <i>141.30</i></div>
    <div>Last scheduled payment day: <i>118</i></div>
    <div>Total scheduled payments: <i>565.32</i></div>
    <div>Total principal: <i>317.26</i></div>
    <div>Total interest: <i>248.06</i></div>
</div></fieldset>