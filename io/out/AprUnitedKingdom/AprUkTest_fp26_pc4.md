...
<div>
    <div>Initial interest balance: <i>244.97</i></div>
    <div>Initial cost-to-borrowing ratio: <i>77.21 %</i></div>
    <div>Initial APR: <i>2202.7 %</i></div>
    <div>Level payment: <i>140.56</i></div>
    <div>Final payment: <i>140.55</i></div>
    <div>Last scheduled payment day: <i>117</i></div>
    <div>Total scheduled payments: <i>562.23</i></div>
    <div>Total principal: <i>317.26</i></div>
    <div>Total interest: <i>244.97</i></div>
</div></fieldset>