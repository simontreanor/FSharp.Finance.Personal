...
<div>
    <div>Initial interest balance: <i>252.34</i></div>
    <div>Initial cost-to-borrowing ratio: <i>79.54 %</i></div>
    <div>Initial APR: <i>3996.6 %</i></div>
    <div>Level payment: <i>113.93</i></div>
    <div>Final payment: <i>113.88</i></div>
    <div>Last scheduled payment day: <i>128</i></div>
    <div>Total scheduled payments: <i>569.60</i></div>
    <div>Total principal: <i>317.26</i></div>
    <div>Total interest: <i>252.34</i></div>
</div></fieldset>