...
<div>
    <div>Initial interest balance: <i>238.77</i></div>
    <div>Initial cost-to-borrowing ratio: <i>75.26 %</i></div>
    <div>Initial APR: <i>2290.2 %</i></div>
    <div>Level payment: <i>139.01</i></div>
    <div>Final payment: <i>139.00</i></div>
    <div>Last scheduled payment day: <i>115</i></div>
    <div>Total scheduled payments: <i>556.03</i></div>
    <div>Total principal: <i>317.26</i></div>
    <div>Total interest: <i>238.77</i></div>
</div></fieldset>