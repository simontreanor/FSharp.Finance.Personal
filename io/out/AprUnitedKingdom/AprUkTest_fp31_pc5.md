...
<div>
    <div>Initial interest balance: <i>328.80</i></div>
    <div>Initial cost-to-borrowing ratio: <i>103.64 %</i></div>
    <div>Initial APR: <i>2051.3 %</i></div>
    <div>Level payment: <i>129.22</i></div>
    <div>Final payment: <i>129.18</i></div>
    <div>Last scheduled payment day: <i>154</i></div>
    <div>Total scheduled payments: <i>646.06</i></div>
    <div>Total principal: <i>317.26</i></div>
    <div>Total interest: <i>328.80</i></div>
</div></fieldset>