...
<div>
    <div>Initial interest balance: <i>385.69</i></div>
    <div>Initial cost-to-borrowing ratio: <i>121.57 %</i></div>
    <div>Initial APR: <i>2283.6 %</i></div>
    <div>Level payment: <i>117.16</i></div>
    <div>Final payment: <i>117.15</i></div>
    <div>Last scheduled payment day: <i>180</i></div>
    <div>Total scheduled payments: <i>702.95</i></div>
    <div>Total principal: <i>317.26</i></div>
    <div>Total interest: <i>385.69</i></div>
</div></fieldset>