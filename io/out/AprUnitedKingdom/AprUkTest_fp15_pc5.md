...
<div>
    <div>Initial interest balance: <i>279.01</i></div>
    <div>Initial cost-to-borrowing ratio: <i>87.94 %</i></div>
    <div>Initial APR: <i>2975.2 %</i></div>
    <div>Level payment: <i>119.26</i></div>
    <div>Final payment: <i>119.23</i></div>
    <div>Last scheduled payment day: <i>137</i></div>
    <div>Total scheduled payments: <i>596.27</i></div>
    <div>Total principal: <i>317.26</i></div>
    <div>Total interest: <i>279.01</i></div>
</div></fieldset>