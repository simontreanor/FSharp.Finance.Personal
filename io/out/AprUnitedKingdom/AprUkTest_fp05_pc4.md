...
<div>
    <div>Initial interest balance: <i>179.85</i></div>
    <div>Initial cost-to-borrowing ratio: <i>56.69 %</i></div>
    <div>Initial APR: <i>3787.6 %</i></div>
    <div>Level payment: <i>124.28</i></div>
    <div>Final payment: <i>124.27</i></div>
    <div>Last scheduled payment day: <i>96</i></div>
    <div>Total scheduled payments: <i>497.11</i></div>
    <div>Total principal: <i>317.26</i></div>
    <div>Total interest: <i>179.85</i></div>
</div></fieldset>