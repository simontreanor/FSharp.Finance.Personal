...
<div>
    <div>Initial interest balance: <i>293.81</i></div>
    <div>Initial cost-to-borrowing ratio: <i>92.61 %</i></div>
    <div>Initial APR: <i>2607.5 %</i></div>
    <div>Level payment: <i>122.22</i></div>
    <div>Final payment: <i>122.19</i></div>
    <div>Last scheduled payment day: <i>142</i></div>
    <div>Total scheduled payments: <i>611.07</i></div>
    <div>Total principal: <i>317.26</i></div>
    <div>Total interest: <i>293.81</i></div>
</div></fieldset>