...
<div>
    <div>Initial interest balance: <i>331.77</i></div>
    <div>Initial cost-to-borrowing ratio: <i>104.57 %</i></div>
    <div>Initial APR: <i>2013.1 %</i></div>
    <div>Level payment: <i>129.81</i></div>
    <div>Final payment: <i>129.79</i></div>
    <div>Last scheduled payment day: <i>155</i></div>
    <div>Total scheduled payments: <i>649.03</i></div>
    <div>Total principal: <i>317.26</i></div>
    <div>Total interest: <i>331.77</i></div>
</div></fieldset>