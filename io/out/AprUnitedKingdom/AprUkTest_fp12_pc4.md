...
<div>
    <div>Initial interest balance: <i>201.54</i></div>
    <div>Initial cost-to-borrowing ratio: <i>63.53 %</i></div>
    <div>Initial APR: <i>3033.9 %</i></div>
    <div>Level payment: <i>129.71</i></div>
    <div>Final payment: <i>129.67</i></div>
    <div>Last scheduled payment day: <i>103</i></div>
    <div>Total scheduled payments: <i>518.80</i></div>
    <div>Total principal: <i>317.26</i></div>
    <div>Total interest: <i>201.54</i></div>
</div></fieldset>