...
<div>
    <div>Initial interest balance: <i>401.93</i></div>
    <div>Initial cost-to-borrowing ratio: <i>126.69 %</i></div>
    <div>Initial APR: <i>2048.2 %</i></div>
    <div>Level payment: <i>119.87</i></div>
    <div>Final payment: <i>119.84</i></div>
    <div>Last scheduled payment day: <i>185</i></div>
    <div>Total scheduled payments: <i>719.19</i></div>
    <div>Total principal: <i>317.26</i></div>
    <div>Total interest: <i>401.93</i></div>
</div></fieldset>