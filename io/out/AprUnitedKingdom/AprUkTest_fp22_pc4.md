...
<div>
    <div>Initial interest balance: <i>232.57</i></div>
    <div>Initial cost-to-borrowing ratio: <i>73.31 %</i></div>
    <div>Initial APR: <i>2385.6 %</i></div>
    <div>Level payment: <i>137.46</i></div>
    <div>Final payment: <i>137.45</i></div>
    <div>Last scheduled payment day: <i>113</i></div>
    <div>Total scheduled payments: <i>549.83</i></div>
    <div>Total principal: <i>317.26</i></div>
    <div>Total interest: <i>232.57</i></div>
</div></fieldset>