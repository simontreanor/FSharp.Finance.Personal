...
<div>
    <div>Initial interest balance: <i>265.25</i></div>
    <div>Initial cost-to-borrowing ratio: <i>83.61 %</i></div>
    <div>Initial APR: <i>1970.8 %</i></div>
    <div>Level payment: <i>145.63</i></div>
    <div>Final payment: <i>145.62</i></div>
    <div>Last scheduled payment day: <i>124</i></div>
    <div>Total scheduled payments: <i>582.51</i></div>
    <div>Total principal: <i>317.26</i></div>
    <div>Total interest: <i>265.25</i></div>
</div></fieldset>