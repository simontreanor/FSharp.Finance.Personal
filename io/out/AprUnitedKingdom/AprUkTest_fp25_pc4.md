...
<div>
    <div>Initial interest balance: <i>241.86</i></div>
    <div>Initial cost-to-borrowing ratio: <i>76.23 %</i></div>
    <div>Initial APR: <i>2245.5 %</i></div>
    <div>Level payment: <i>139.79</i></div>
    <div>Final payment: <i>139.75</i></div>
    <div>Last scheduled payment day: <i>116</i></div>
    <div>Total scheduled payments: <i>559.12</i></div>
    <div>Total principal: <i>317.26</i></div>
    <div>Total interest: <i>241.86</i></div>
</div></fieldset>