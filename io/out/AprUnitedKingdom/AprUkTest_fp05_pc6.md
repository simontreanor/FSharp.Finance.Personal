...
<div>
    <div>Initial interest balance: <i>322.12</i></div>
    <div>Initial cost-to-borrowing ratio: <i>101.53 %</i></div>
    <div>Initial APR: <i>4345 %</i></div>
    <div>Level payment: <i>106.57</i></div>
    <div>Final payment: <i>106.53</i></div>
    <div>Last scheduled payment day: <i>158</i></div>
    <div>Total scheduled payments: <i>639.38</i></div>
    <div>Total principal: <i>317.26</i></div>
    <div>Total interest: <i>322.12</i></div>
</div></fieldset>