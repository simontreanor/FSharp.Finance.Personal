...
<div>
    <div>Initial interest balance: <i>336.55</i></div>
    <div>Initial cost-to-borrowing ratio: <i>106.08 %</i></div>
    <div>Initial APR: <i>3611 %</i></div>
    <div>Level payment: <i>108.97</i></div>
    <div>Final payment: <i>108.96</i></div>
    <div>Last scheduled payment day: <i>163</i></div>
    <div>Total scheduled payments: <i>653.81</i></div>
    <div>Total principal: <i>317.26</i></div>
    <div>Total interest: <i>336.55</i></div>
</div></fieldset>