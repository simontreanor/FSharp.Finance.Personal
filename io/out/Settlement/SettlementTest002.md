...
<div>
    <div>Generated settlement: <i>105.04 on day 122</i></div>
    <div>Final balance status: <i>closed</i></div>
    <div>Effective interest rate: <i>0.5135409836 % per day</i></div>
    <div>Final cost-to-borrowing ratio: <i>62.65 %</i></div>
