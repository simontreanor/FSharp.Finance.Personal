...
<div>
    ...
    <div>Initial cost-to-borrowing ratio: <i>47.77 %</i></div>
    <div>Initial APR: <i>1312.3 %</i></div>
    <div>Level payment: <i>36.94</i></div>
    <div>Final payment: <i>36.95</i></div>
    <div>Last scheduled payment day: <i>103</i></div>
    <div>Total scheduled payments: <i>147.77</i></div>
    <div>Total principal: <i>100.00</i></div>
    <div>Total interest: <i>47.77</i></div>
</div></fieldset>