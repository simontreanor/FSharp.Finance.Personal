<h2>PaymentScheduleTest_Monthly_0700_fp20_r4</h2>
<table>
...
<div>
    ...
    <div>Level payment: <i>273.65</i></div>
    <div>Final payment: <i>273.65</i></div>
    <div>Last scheduled payment day: <i>111</i></div>
    <div>Total scheduled payments: <i>1,094.60</i></div>
    <div>Total principal: <i>700.00</i></div>
    <div>Total interest: <i>394.60</i></div>
</div></fieldset>