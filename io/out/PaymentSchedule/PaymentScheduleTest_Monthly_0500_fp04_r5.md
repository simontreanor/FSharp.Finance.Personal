...
<div>
    ...
    <div>Initial cost-to-borrowing ratio: <i>52.44 %</i></div>
    <div>Initial APR: <i>1281.2 %</i></div>
    <div>Level payment: <i>152.44</i></div>
    <div>Final payment: <i>152.43</i></div>
    <div>Last scheduled payment day: <i>126</i></div>
    <div>Total scheduled payments: <i>762.19</i></div>
    <div>Total principal: <i>500.00</i></div>
    <div>Total interest: <i>262.19</i></div>
</div></fieldset>