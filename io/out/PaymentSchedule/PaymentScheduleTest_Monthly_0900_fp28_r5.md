<h2>PaymentScheduleTest_Monthly_0900_fp28_r5</h2>
<table>
...
<div>
    ...
    <div>Initial cost-to-borrowing ratio: <i>80.14 %</i></div>
    <div>Initial APR: <i>1267.9 %</i></div>
    <div>Level payment: <i>324.26</i></div>
    <div>Final payment: <i>324.26</i></div>
    <div>Last scheduled payment day: <i>149</i></div>
    <div>Total scheduled payments: <i>1,621.30</i></div>
    <div>Total principal: <i>900.00</i></div>
    <div>Total interest: <i>721.30</i></div>
</div></fieldset>