<h2>PaymentScheduleTest_Monthly_1500_fp20_r6</h2>
<table>
...
<div>
    ...
    <div>Level payment: <i>467.29</i></div>
    <div>Final payment: <i>467.33</i></div>
    <div>Last scheduled payment day: <i>172</i></div>
    <div>Total scheduled payments: <i>2,803.78</i></div>
    <div>Total principal: <i>1,500.00</i></div>
    <div>Total interest: <i>1,303.78</i></div>
</div></fieldset>