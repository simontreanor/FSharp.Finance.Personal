<h2>PaymentScheduleTest_Monthly_0900_fp08_r6</h2>
<table>
...
<div>
    ...
    <div>Initial cost-to-borrowing ratio: <i>71.49 %</i></div>
    <div>Initial APR: <i>1291.1 %</i></div>
    <div>Level payment: <i>257.22</i></div>
    <div>Final payment: <i>257.29</i></div>
    <div>Last scheduled payment day: <i>160</i></div>
    <div>Total scheduled payments: <i>1,543.39</i></div>
    <div>Total principal: <i>900.00</i></div>
    <div>Total interest: <i>643.39</i></div>
</div></fieldset>