...
<div>
    ...
    <div>Initial cost-to-borrowing ratio: <i>57.16 %</i></div>
    <div>Initial APR: <i>1296.5 %</i></div>
    <div>Level payment: <i>94.29</i></div>
    <div>Final payment: <i>94.31</i></div>
    <div>Last scheduled payment day: <i>130</i></div>
    <div>Total scheduled payments: <i>471.47</i></div>
    <div>Total principal: <i>300.00</i></div>
    <div>Total interest: <i>171.47</i></div>
</div></fieldset>