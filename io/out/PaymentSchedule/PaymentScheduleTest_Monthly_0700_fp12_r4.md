...
<div>
    ...
    <div>Initial cost-to-borrowing ratio: <i>47.76 %</i></div>
    <div>Initial APR: <i>1311.9 %</i></div>
    <div>Level payment: <i>258.59</i></div>
    <div>Final payment: <i>258.55</i></div>
    <div>Last scheduled payment day: <i>103</i></div>
    <div>Total scheduled payments: <i>1,034.32</i></div>
    <div>Total principal: <i>700.00</i></div>
    <div>Total interest: <i>334.32</i></div>
</div></fieldset>