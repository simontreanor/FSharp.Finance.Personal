<h2>PaymentScheduleTest_Monthly_1300_fp08_r6</h2>
<table>
...
<div>
    ...
    <div>Initial APR: <i>1291 %</i></div>
    <div>Level payment: <i>371.55</i></div>
    <div>Final payment: <i>371.49</i></div>
    <div>Last scheduled payment day: <i>160</i></div>
    <div>Total scheduled payments: <i>2,229.24</i></div>
    <div>Total principal: <i>1,300.00</i></div>
    <div>Total interest: <i>929.24</i></div>
</div></fieldset>