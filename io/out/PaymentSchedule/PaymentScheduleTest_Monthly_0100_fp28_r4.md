...
<div>
    ...
    <div>Initial cost-to-borrowing ratio: <i>64.5 %</i></div>
    <div>Initial APR: <i>1268.8 %</i></div>
    <div>Level payment: <i>41.13</i></div>
    <div>Final payment: <i>41.11</i></div>
    <div>Last scheduled payment day: <i>119</i></div>
    <div>Total scheduled payments: <i>164.50</i></div>
    <div>Total principal: <i>100.00</i></div>
    <div>Total interest: <i>64.50</i></div>
</div></fieldset>