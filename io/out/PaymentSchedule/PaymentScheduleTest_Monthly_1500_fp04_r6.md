<h2>PaymentScheduleTest_Monthly_1500_fp04_r6</h2>
<table>
...
<div>
    ...
    <div>Level payment: <i>415.84</i></div>
    <div>Final payment: <i>415.86</i></div>
    <div>Last scheduled payment day: <i>156</i></div>
    <div>Total scheduled payments: <i>2,495.06</i></div>
    <div>Total principal: <i>1,500.00</i></div>
    <div>Total interest: <i>995.06</i></div>
</div></fieldset>