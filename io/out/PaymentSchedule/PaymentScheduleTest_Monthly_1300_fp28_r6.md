<h2>PaymentScheduleTest_Monthly_1300_fp28_r6</h2>
<table>
...
<div>
    ...
    <div>Initial cost-to-borrowing ratio: <i>96.63 %</i></div>
    <div>Initial APR: <i>1266.6 %</i></div>
    <div>Level payment: <i>426.02</i></div>
    <div>Final payment: <i>426.04</i></div>
    <div>Last scheduled payment day: <i>180</i></div>
    <div>Total scheduled payments: <i>2,556.14</i></div>
    <div>Total principal: <i>1,300.00</i></div>
    <div>Total interest: <i>1,256.14</i></div>
</div></fieldset>