...
<div>
    ...
    <div>Initial cost-to-borrowing ratio: <i>52.06 %</i></div>
    <div>Initial APR: <i>1308.8 %</i></div>
    <div>Level payment: <i>114.05</i></div>
    <div>Final payment: <i>114.03</i></div>
    <div>Last scheduled payment day: <i>107</i></div>
    <div>Total scheduled payments: <i>456.18</i></div>
    <div>Total principal: <i>300.00</i></div>
    <div>Total interest: <i>156.18</i></div>
</div></fieldset>