<h2>PaymentScheduleTest_Monthly_0900_fp20_r5</h2>
<table>
...
<div>
    ...
    <div>Initial cost-to-borrowing ratio: <i>71.3 %</i></div>
    <div>Initial APR: <i>1292.9 %</i></div>
    <div>Level payment: <i>308.34</i></div>
    <div>Final payment: <i>308.35</i></div>
    <div>Last scheduled payment day: <i>142</i></div>
    <div>Total scheduled payments: <i>1,541.71</i></div>
    <div>Total principal: <i>900.00</i></div>
    <div>Total interest: <i>641.71</i></div>
</div></fieldset>