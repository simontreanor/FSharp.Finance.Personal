...
<div>
    ...
    <div>Initial cost-to-borrowing ratio: <i>91.5 %</i></div>
    <div>Initial APR: <i>1280.4 %</i></div>
    <div>Level payment: <i>414.91</i></div>
    <div>Final payment: <i>414.90</i></div>
    <div>Last scheduled payment day: <i>176</i></div>
    <div>Total scheduled payments: <i>2,489.45</i></div>
    <div>Total principal: <i>1,300.00</i></div>
    <div>Total interest: <i>1,189.45</i></div>
</div></fieldset>