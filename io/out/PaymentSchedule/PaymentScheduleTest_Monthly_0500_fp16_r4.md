...
<div>
    ...
    <div>Initial APR: <i>1309 %</i></div>
    <div>Level payment: <i>190.08</i></div>
    <div>Final payment: <i>190.09</i></div>
    <div>Last scheduled payment day: <i>107</i></div>
    <div>Total scheduled payments: <i>760.33</i></div>
    <div>Total principal: <i>500.00</i></div>
    <div>Total interest: <i>260.33</i></div>
</div></fieldset>