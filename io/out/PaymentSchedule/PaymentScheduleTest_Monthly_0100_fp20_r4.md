...
<div>
    ...
    <div>Initial cost-to-borrowing ratio: <i>56.38 %</i></div>
    <div>Initial APR: <i>1299.7 %</i></div>
    <div>Level payment: <i>39.09</i></div>
    <div>Final payment: <i>39.11</i></div>
    <div>Last scheduled payment day: <i>111</i></div>
    <div>Total scheduled payments: <i>156.38</i></div>
    <div>Total principal: <i>100.00</i></div>
    <div>Total interest: <i>56.38</i></div>
</div></fieldset>