<h2>PaymentScheduleTest_Monthly_1500_fp16_r6</h2>
<table>
...
<div>
    ...
    <div>Initial APR: <i>1295 %</i></div>
    <div>Level payment: <i>454.43</i></div>
    <div>Final payment: <i>454.45</i></div>
    <div>Last scheduled payment day: <i>168</i></div>
    <div>Total scheduled payments: <i>2,726.60</i></div>
    <div>Total principal: <i>1,500.00</i></div>
    <div>Total interest: <i>1,226.60</i></div>
</div></fieldset>