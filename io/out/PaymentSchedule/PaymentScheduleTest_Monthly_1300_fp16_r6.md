<h2>PaymentScheduleTest_Monthly_1300_fp16_r6</h2>
<table>
...
<div>
    ...
    <div>Level payment: <i>393.84</i></div>
    <div>Final payment: <i>393.86</i></div>
    <div>Last scheduled payment day: <i>168</i></div>
    <div>Total scheduled payments: <i>2,363.06</i></div>
    <div>Total principal: <i>1,300.00</i></div>
    <div>Total interest: <i>1,063.06</i></div>
</div></fieldset>