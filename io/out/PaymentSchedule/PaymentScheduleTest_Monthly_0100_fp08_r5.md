...
<div>
    ...
    <div>Initial cost-to-borrowing ratio: <i>57.14 %</i></div>
    <div>Initial APR: <i>1295.9 %</i></div>
    <div>Level payment: <i>31.43</i></div>
    <div>Final payment: <i>31.42</i></div>
    <div>Last scheduled payment day: <i>130</i></div>
    <div>Total scheduled payments: <i>157.14</i></div>
    <div>Total principal: <i>100.00</i></div>
    <div>Total interest: <i>57.14</i></div>
</div></fieldset>