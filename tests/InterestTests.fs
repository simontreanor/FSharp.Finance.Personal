...
module InterestTests =
    ...
    module Cca2004Tests =
        ...
        let Cca2004Test006 () =
            ...
            let description = "Initial statement (actuarial interest) matching total interest amount of £1459.36"
        ...
        let Cca2004Test007 () =
            ...
            let description = "Initial statement (actuarial interest, autogenerated payment amounts) matching level payment of £134.57"
            let p =
                { parameters2 with
        ...
        let Cca2004Test008 () =
            ...
            let description = "CCA 2004 rebate example using library method (actuarial interest)"
            let p =
                { parameters2 with
