    ...
    module ConfigEdges =
        ...
        let ``5) Checking that the fees refund behaves correctly`` () =
            ...
            let originalScheduledPayments = [|
                { PaymentDay = 4<OffsetDay>; PaymentDetails = ScheduledPayment 11859L<Cent> }
                { PaymentDay = 11<OffsetDay>; PaymentDetails = ScheduledPayment 11859L<Cent> }
                { PaymentDay = 18<OffsetDay>; PaymentDetails = ScheduledPayment 11859L<Cent> }
                { PaymentDay = 25<OffsetDay>; PaymentDetails = ScheduledPayment 11859L<Cent> }
                { PaymentDay = 32<OffsetDay>; PaymentDetails = ScheduledPayment 11859L<Cent> }
                { PaymentDay = 39<OffsetDay>; PaymentDetails = ScheduledPayment 11859L<Cent> }
                { PaymentDay = 46<OffsetDay>; PaymentDetails = ScheduledPayment 11859L<Cent> }
                { PaymentDay = 53<OffsetDay>; PaymentDetails = ScheduledPayment 11859L<Cent> }
                { PaymentDay = 60<OffsetDay>; PaymentDetails = ScheduledPayment 11859L<Cent> }
                { PaymentDay = 67<OffsetDay>; PaymentDetails = ScheduledPayment 11859L<Cent> }
                { PaymentDay = 74<OffsetDay>; PaymentDetails = ScheduledPayment 11859L<Cent> }
                { PaymentDay = 81<OffsetDay>; PaymentDetails = ScheduledPayment 11859L<Cent> }
                { PaymentDay = 88<OffsetDay>; PaymentDetails = ScheduledPayment 11859L<Cent> }
                { PaymentDay = 95<OffsetDay>; PaymentDetails = ScheduledPayment 11859L<Cent> }
                { PaymentDay = 102<OffsetDay>; PaymentDetails = ScheduledPayment 11859L<Cent> }
                { PaymentDay = 109<OffsetDay>; PaymentDetails = ScheduledPayment 11859L<Cent> }
                { PaymentDay = 116<OffsetDay>; PaymentDetails = ScheduledPayment 11859L<Cent> }
                { PaymentDay = 123<OffsetDay>; PaymentDetails = ScheduledPayment 11859L<Cent> }
                { PaymentDay = 130<OffsetDay>; PaymentDetails = ScheduledPayment 11859L<Cent> }
                { PaymentDay = 137<OffsetDay>; PaymentDetails = ScheduledPayment 11859L<Cent> }
                { PaymentDay = 144<OffsetDay>; PaymentDetails = ScheduledPayment 11859L<Cent> }
                { PaymentDay = 151<OffsetDay>; PaymentDetails = ScheduledPayment 11859L<Cent> }
                { PaymentDay = 158<OffsetDay>; PaymentDetails = ScheduledPayment 11859L<Cent> }
                { PaymentDay = 165<OffsetDay>; PaymentDetails = ScheduledPayment 11859L<Cent> }
                { PaymentDay = 172<OffsetDay>; PaymentDetails = ScheduledPayment 11846L<Cent> }
            |]
            ...
            let actualPayments = [|
                ...
                // { PaymentDay = 12<OffsetDay>; PaymentDetails = ActualPayment (PaymentStatus.Failed (11859L<Cent>, [||])) }
                // { PaymentDay = 12<OffsetDay>; PaymentDetails = ActualPayment (PaymentStatus.Failed (11859L<Cent>, [||])) }
                { PaymentDay = 13<OffsetDay>; PaymentDetails = ActualPayment (PaymentStatus.Confirmed 11859L<Cent>) }
                ...
                { PaymentDay = 18<OffsetDay>; PaymentDetails = ActualPayment (PaymentStatus.Confirmed 11859L<Cent>) }
                ...
                { PaymentDay = 74<OffsetDay>; PaymentDetails = ActualPayment (PaymentStatus.Confirmed 11859L<Cent>) }
                // { PaymentDay = 74<OffsetDay>; PaymentDetails = ActualPayment (PaymentStatus.Failed (11859L<Cent>, [||])) }
                { PaymentDay = 75<OffsetDay>; PaymentDetails = ActualPayment (PaymentStatus.Confirmed 11859L<Cent>) }
                ...
                // { PaymentDay = 80<OffsetDay>; PaymentDetails = ActualPayment (PaymentStatus.Failed (11859L<Cent>, [||])) }
                { PaymentDay = 81<OffsetDay>; PaymentDetails = ActualPayment (PaymentStatus.Confirmed 11859L<Cent>) }
                { PaymentDay = 81<OffsetDay>; PaymentDetails = ActualPayment (PaymentStatus.Confirmed 11859L<Cent>) }
                { PaymentDay = 81<OffsetDay>; PaymentDetails = ActualPayment (PaymentStatus.Confirmed 11859L<Cent>) }
                { PaymentDay = 82<OffsetDay>; PaymentDetails = ActualPayment (PaymentStatus.Confirmed 11859L<Cent>) }
                ...
                { PaymentDay = 87<OffsetDay>; PaymentDetails = ActualPayment (PaymentStatus.Confirmed 11859L<Cent>) }
                { PaymentDay = 87<OffsetDay>; PaymentDetails = ActualPayment (PaymentStatus.Confirmed 11859L<Cent>) }
                { PaymentDay = 88<OffsetDay>; PaymentDetails = ActualPayment (PaymentStatus.Confirmed 11859L<Cent>) }
                ...
                { PaymentDay = 95<OffsetDay>; PaymentDetails = ActualPayment (PaymentStatus.Confirmed 12363L<Cent>) }
                ...
                { PaymentDay = 98<OffsetDay>; PaymentDetails = ActualPayment (PaymentStatus.Confirmed 12096L<Cent>) }
                ...
                { PaymentDay = 201<OffsetDay>; PaymentDetails = ActualPayment (PaymentStatus.Confirmed 12489L<Cent>) }
                { PaymentDay = 234<OffsetDay>; PaymentDetails = ActualPayment (PaymentStatus.Confirmed 12489L<Cent>) }
            |]
                ...
                voption {
                    ...
                    let quoteSp =
                        { sp with
                            ...
                            ScheduleType = Reschedule originalFinalPaymentDay
                            PaymentSchedule =
                                [|
                                    originalScheduledPayments
                                    [|
                                        { PaymentDay = 201<OffsetDay>; PaymentDetails = ScheduledPayment 12489L<Cent> }
                                        { PaymentDay = 232<OffsetDay>; PaymentDetails = ScheduledPayment 12489L<Cent> }
                                        { PaymentDay = 262<OffsetDay>; PaymentDetails = ScheduledPayment 12489L<Cent> }
                                        { PaymentDay = 293<OffsetDay>; PaymentDetails = ScheduledPayment 12489L<Cent> }
                                        { PaymentDay = 323<OffsetDay>; PaymentDetails = ScheduledPayment 12489L<Cent> }
                                        { PaymentDay = 354<OffsetDay>; PaymentDetails = ScheduledPayment 79109L<Cent> }
                                    |]
                                |]
                                |> Array.concat
                                |> IrregularSchedule
