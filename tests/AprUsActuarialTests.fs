...
module AprUsActuarialTests =
    ...
    let ``Example (c)(1)(i): Monthly payments (regular first period)`` () =
        let actual =
            calculate1 5000_00L<Cent> 230_00L<Cent> 24 (Monthly(1, 1978, 2, 10)) (Date(1978, 1, 10))
    ...
    let ``Example (c)(1)(ii): Monthly payments (long first period)`` () =
        let actual =
            calculate1 6000_00L<Cent> 200_00L<Cent> 36 (Monthly(1, 1978, 4, 1)) (Date(1978, 2, 10))
    ...
    let ``Example (c)(1)(iii): Semimonthly payments (short first period)`` () =
        let actual =
            calculate1 5000_00L<Cent> 219_17L<Cent> 24 (SemiMonthly(1978, 3, 1, 16)) (Date(1978, 2, 23))
    ...
    let ``Example (c)(1)(iv): Quarterly payments (long first period)`` () =
        let actual =
            calculate1 10000_00L<Cent> 385_00L<Cent> 40 (Monthly(3, 1978, 10, 1)) (Date(1978, 5, 23))
    ...
    let ``Example (c)(1)(v): Weekly payments (long first period)`` () =
        let actual =
            calculate1 500_00L<Cent> 17_60L<Cent> 30 (Weekly(1, Date(1978, 4, 21))) (Date(1978, 3, 20))
    ...
    let ``Example (c)(2)(i): Monthly payments (regular first period and irregular first payment)`` () =
        ...
        let actual =
            calculate2 5000_00L<Cent> firstPayment 230_00L<Cent> 23 (Monthly(1, 1978, 3, 10)) (Date(1978, 1, 10))
    ...
    let ``Example (c)(2)(ii): Payments every 4 weeks (long first period and irregular first payment)`` () =
        ...
        let actual =
            calculate2 400_00L<Cent> firstPayment 38_31L<Cent> 11 (Weekly(4, Date(1978, 5, 18))) (Date(1978, 3, 18))
    ...
    let ``Example (c)(3)(i): Monthly payments (regular first period and irregular final payment)`` () =
        ...
        let actual =
            calculate3 5000_00L<Cent> lastPayment 230_00L<Cent> 23 (Monthly(1, 1978, 2, 10)) (Date(1978, 1, 10))
    ...
    let ``Example (c)(3)(ii): Payments every 2 weeks (short first period and irregular final payment)`` () =
        ...
        let actual =
            calculate3 200_00L<Cent> lastPayment 9_50L<Cent> 19 (Weekly(2, Date(1978, 4, 11))) (Date(1978, 4, 3))
    ...
    module ExtraExamples =
        ...
        let ``Example (c)(1)(iv) [modified]: Quarterly payments (shorter first period)`` () =
            let actual =
                calculate1 10000_00L<Cent> 385_00L<Cent> 40 (Monthly(3, 1978, 10, 1)) (Date(1978, 6, 23))
        ...
        let ``Example (c)(1)(iv) [modified]: Quarterly payments (shorter first period: less than unit-period)`` () =
            let actual =
                calculate1 10000_00L<Cent> 385_00L<Cent> 40 (Monthly(3, 1978, 10, 1)) (Date(1978, 7, 23))
        ...
        let ``Daily payments`` () =
            let actual =
                calculate1 1000_00L<Cent> 220_00L<Cent> 5 (Daily(Date(2023, 11, 30))) (Date(2023, 10, 26))
        ...
        let ``Weekly payments with long first period`` () =
            let actual =
                calculate1 1000_00L<Cent> 250_00L<Cent> 5 (Weekly(1, Date(2023, 11, 30))) (Date(2023, 10, 28))
        ...
        let ``Weekly payments with first period equal to unit-period`` () =
            let actual =
                calculate1 1000_00L<Cent> 250_00L<Cent> 5 (Weekly(1, Date(2023, 11, 30))) (Date(2023, 11, 23))
        ...
        let ``Weekly payments with first period shorter than unit-period`` () =
            let actual =
                calculate1 1000_00L<Cent> 250_00L<Cent> 5 (Weekly(1, Date(2023, 11, 30))) (Date(2023, 11, 24))
        ...
        let ``Yearly payments`` () =
            let actual =
                calculate1 1000_00L<Cent> 500_00L<Cent> 5 (Monthly(12, 2023, 11, 30)) (Date(2023, 10, 26))
